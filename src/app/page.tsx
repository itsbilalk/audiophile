    ...
    <>
      <div className="min-h-screen md:w-full text-[var(--colour-white)]">
        ...
        <div className="flex flex-col justify-center bg-[var(--colour-white)] align-middle ">
          <Categories />
          <div className="bg-[var(--colour-dark-orange)]  bg-[50%_-8.125rem] md:bg-[50%_-15.125rem] bg-cover ml-6 mr-6 bg-[url(../../public/home/desktop/pattern-circles.svg)] bg-no-repeat text-center rounded-lg">
            <Image
              src={speaker}
              alt="image of the zx9 speaker"
              className="h-52 w-43 ml-auto mr-auto mt-13.5"
            />
            <h2 className="h3 uppercase mt-8 ">
              zx9 <br /> speaker
            </h2>
